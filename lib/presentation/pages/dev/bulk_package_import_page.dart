...
const List<PackageDef> _packageDefinitions = [
  ...
  PackageDef(
    groupName:    'A2 EN-DE expressions',
    iconIndex:    4,
  ...
  PackageDef(
    groupName:    'B1 EN-DE expressions',
    iconIndex:    4,
  ...
  PackageDef(
    groupName:    'B2 EN-DE expressions',
    iconIndex:    4,
  ...
  PackageDef(
    groupName:    'C1 EN-DE expressions',
    iconIndex:    4,
  ...
  PackageDef(
    groupName:    'C2 EN-DE expressions',
    iconIndex:    4,
