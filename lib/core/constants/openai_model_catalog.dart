...
class OpenAiModelCatalog {
  // Keep the default on a stable chat-completions model.
  // Several GPT-5 variants are unreliable or unsupported for the current API flow.
  static const String defaultModelId = 'gpt-4.1';
